          ...
          {hasThreeImages ? (
            <>
              ...
              <div className="absolute -left-2 top-1/2 -translate-y-1/3 z-10 w-1/2 h-1/2 -rotate-12 transition-transform duration-500 group-hover:-rotate-45 group-hover:-translate-x-2">
                <Image src={img2} alt="Category" fill sizes="(max-width: 768px) 20vw, 120px" className="object-contain drop-shadow-md" {...getBlurPlaceholderProps(category.secondaryBlurDataURL)} />
              </div>
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-2/3 z-20 w-3/5 h-3/5 transition-transform duration-500 group-hover:-translate-y-3 group-hover:scale-105">
                <Image src={img1} alt="Category" fill sizes="(max-width: 768px) 20vw, 120px" className="object-contain drop-shadow-xl" {...getBlurPlaceholderProps(category.blurDataURL)} />
              </div>
              ...
              <div className="absolute -right-2 top-1/2 -translate-y-1/3 z-10 w-1/2 h-1/2 rotate-12 transition-transform duration-500 group-hover:rotate-45 group-hover:translate-x-2">
                <Image src={img3} alt="Category" fill sizes="(max-width: 768px) 20vw, 120px" className="object-contain drop-shadow-md" {...getBlurPlaceholderProps(category.tertiaryBlurDataURL)} />
              </div>
            </>
          ) : hasTwoImages ? (
            <>
              ...
              <div className="absolute left-0 top-1/2 -translate-y-1/2 z-20 w-3/5 h-3/5 -rotate-6 transition-transform duration-500 group-hover:-rotate-12 group-hover:-translate-x-1">
                <Image src={img1 || images[0]} alt="Category" fill sizes="(max-width: 768px) 20vw, 120px" className="object-contain drop-shadow-md" {...getBlurPlaceholderProps(category.blurDataURL)} />
              </div>
              {/* Right Image */}
              <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-3/5 h-3/5 rotate-6 transition-transform duration-500 group-hover:rotate-12 group-hover:translate-x-1">
                <Image src={img2 || images[1]} alt="Category" fill sizes="(max-width: 768px) 20vw, 120px" className="object-contain drop-shadow-md" {...getBlurPlaceholderProps(category.secondaryBlurDataURL || category.blurDataURL)} />
              </div>
            </>
          ) : hasOneImage ? (
