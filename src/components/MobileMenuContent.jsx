...
export default function MobileMenuContent({
  ...
  return (
    <Tabs defaultValue="menu" className="flex h-full min-h-0 w-full flex-col overflow-hidden bg-background">
      ...
      <div className="shrink-0 flex flex-col gap-3 border-t border-border/80 p-3.5 pb-[calc(env(safe-area-inset-bottom,0.75rem)+1.25rem)] bg-card/90 backdrop-blur-sm">
        {/* Auth / Logout Button */}
        {!session ? (
          <Link href="/auth/signin" onClick={() => setIsSidebarOpen(false)} className="w-full">
            <Button className="w-full bg-[#006B5F] hover:bg-[#00554c] text-white rounded-xl h-10 text-xs sm:text-sm font-semibold shadow-xs transition-all active:scale-[0.98] gap-2">
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 min-w-0 flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-muted/60 border border-border/60">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-xs font-semibold text-foreground truncate">{session.user?.name || 'Account'}</p>
            ...
            <Button
              ...
              className="h-10 px-3 rounded-xl border-red-200/90 dark:border-red-900/60 bg-red-50/70 hover:bg-red-100 dark:bg-red-950/40 text-red-600 dark:text-red-400 text-xs font-semibold transition-all active:scale-95 shadow-none shrink-0 gap-1.5 cursor-pointer"
              title="Sign Out"
            >
        ...
        <div className="flex items-center justify-center gap-3 pt-0.5">
          {/* Facebook */}
          <a
            href="https://www.facebook.com/chinauniquestore"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="size-8 sm:size-9 rounded-full bg-muted/70 hover:bg-blue-50 dark:hover:bg-blue-950/50 border border-border/70 hover:border-blue-200 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-2xs group"
          >
            <svg viewBox="0 0 24 24" className="size-4 fill-[#1877F2] transition-transform group-hover:scale-105">
          ...
          {/* WhatsApp */}
          <a
            href="https://wa.me/923307779933"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="size-8 sm:size-9 rounded-full bg-muted/70 hover:bg-emerald-50 dark:hover:bg-emerald-950/50 border border-border/70 hover:border-emerald-200 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-2xs group"
          >
            <svg viewBox="0 0 24 24" className="size-4 fill-[#25D366] transition-transform group-hover:scale-105">
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/chinauniquestore"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Instagram"
            className="size-8 sm:size-9 rounded-full bg-muted/70 hover:bg-rose-50 dark:hover:bg-rose-950/50 border border-border/70 hover:border-rose-200 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-2xs group"
          >
            <svg viewBox="0 0 24 24" className="size-4 transition-transform group-hover:scale-105">
              <defs>
                <linearGradient id="ig-grad-mobile" x1="1" y1="1" x2="0" y2="0">
          ...
          {/* TikTok */}
          <a
            href="https://www.tiktok.com/@chinauniquestore"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="TikTok"
            className="size-8 sm:size-9 rounded-full bg-muted/70 hover:bg-neutral-100 dark:hover:bg-neutral-800 border border-border/70 hover:border-neutral-300 flex items-center justify-center transition-all duration-200 hover:scale-110 active:scale-95 shadow-2xs group"
          >
            <svg viewBox="0 0 24 24" className="size-4 fill-foreground transition-transform group-hover:scale-105">
